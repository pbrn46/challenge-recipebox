      ...
      <div className="app">
        <div className="container">
          <div className="jumbotron">
            ...
            <p>This app will save any changes to local browser storage for safe-keeping. Clicking "Reset Storage" will clear all data and restore the initial sample data.</p>
            <h4>Features</h4>
            <ul>
